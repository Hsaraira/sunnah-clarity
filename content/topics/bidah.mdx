...
<HadithBlock
  arabic="وَإِيَّاكُمْ وَمُحْدَثَاتِ الأُمُورِ فَإِنَّ كُلَّ مُحْدَثَةٍ بِدْعَةٌ وَكُلَّ بِدْعَةٍ ضَلاَلَةٌ"
  translation="Avoid novelties in religion, for every novelty is an innovation (bid'a), and every innovation is misguidance."
  source="Sunan Abu Dawud, no. 4607"
...
<HadithBlock
  ...
  translation="Whoever introduces into this affair of ours (Islam) something that is not of it — it is to be rejected."
  source="Sahih al-Bukhari, no. 2697; Sahih Muslim, no. 1718"
...
<HadithBlock
  arabic="يَا بِلاَلُ حَدِّثْنِي بِأَرْجَى عَمَلٍ عَمِلْتَهُ فِي الإِسْلاَمِ، فَإِنِّي سَمِعْتُ دَفَّ نَعْلَيْكَ بَيْنَ يَدَىَّ فِي الْجَنَّةِ"
  ...
  source="Sahih al-Bukhari, no. 1149; Sahih Muslim, no. 2458"
...
<HadithBlock
  ...
  source="Sahih al-Bukhari, no. 799; Sahih Muslim, no. 600"
  narrator="Rifa'a ibn Rafi (رضي الله عنه)"
/>

[Ibn Hajar](/scholars/ibn-hajar-al-asqalani) states that this hadith demonstrates **the permissibility of initiating new expressions of dhikr in prayer** — even in the most carefully regulated act of worship — as long as they don't contradict what has been established. The man invented a new supplication on the spot, and the Prophet ﷺ approved it with the highest praise.

### Example 3: Reciting Only Surat al-Ikhlas

<HadithBlock
  arabic="لِأَنَّهَا صِفَةُ الرَّحْمَنِ، وَأَنَا أُحِبُّ أَنْ أَقْرَأَهَا"
  ...
  source="Sahih al-Bukhari, no. 7375"
/>
...
<HadithBlock
  ...
  source="Sunan Abu Dawud, no. 1493; Sunan Ibn Majah, no. 3857"
...
This is perhaps the most powerful single proof. [Umar ibn al-Khattab (رضي الله عنه)](/scholars/umar-ibn-al-khattab), the second Caliph of Islam, gathered the Muslims to pray tarawih behind one imam during Ramadan. When he saw them praying together, he said:

<ScholarQuote
  scholar="Umar ibn al-Khattab (رضي الله عنه)"
  scholarSlug="umar-ibn-al-khattab"
...
Based on all of this evidence, the greatest scholars of Islam classified innovation into five categories. This classification was established by **[al-Izz ibn Abd al-Salam](/scholars/al-izz-ibn-abd-al-salam)** (d. 660 AH), known as "the Sultan of Scholars," in his work *al-Qawa'id al-Kubra*:
...
- **[Imam al-Nawawi](/scholars/imam-al-nawawi)** — the greatest commentator on Sahih Muslim
- **[Ibn Hajar al-Asqalani](/scholars/ibn-hajar-al-asqalani)** — the greatest commentator on Sahih al-Bukhari
- **The vast majority of Islamic scholars** across all four madhabs

> **See who:** Browse [the full visual — 19 scholars, four schools, twelve centuries →](/scholars/lineage)
...
<MisconceptionBlock
  claim="If the Prophet ﷺ and his Companions didn't do it, it's forbidden."
  response={
    <>
      This principle, if applied consistently, would invalidate the Quran&apos;s compilation into a single book, all six major hadith collections, diacritical marks on the Quran, formal Islamic schools, and the very science of hadith authentication. The correct Sunni principle is that new practices which <em>align</em> with Sacred Law are evaluated on their merits — and those which <em>contradict</em> it are rejected. This is exactly what the Prophet ﷺ did when he accepted new supplications, new dhikr phrases, and new prayer habits from the Companions, while rejecting practices that violated established principles.
    </>
  }
/>

<MisconceptionBlock
  claim="The scholars who classify bid'a into categories are going against the hadith."
  response={
    <>
      The scholars who classify bid&apos;a into categories <em>are</em> the scholars who narrated, compiled, authenticated, and explained these hadiths. <a href="/scholars/imam-al-nawawi">Imam al-Nawawi</a> wrote the definitive commentary on Sahih Muslim. <a href="/scholars/ibn-hajar-al-asqalani">Ibn Hajar al-Asqalani</a> wrote the definitive commentary on Sahih al-Bukhari. <a href="/scholars/imam-al-shafii">Imam al-Shafi&apos;i</a> founded one of the four madhabs. These are not fringe voices — they are the very scholars through whom the hadith tradition was preserved and transmitted. To claim they &quot;went against the hadith&quot; is to claim they did not understand the texts they devoted their lives to.
    </>
  }
/>
...
[Imam al-Shatibi](/scholars/imam-al-shatibi) (d. 790 AH) argued in his *al-I'tisam* that bid'a in the *technical religious sense* is always blameworthy. This is the strongest classical argument against the five-category framework, and it deserves serious engagement.
...
| All scholars agree bid'a is categorically forbidden | [Imam al-Nawawi](/scholars/imam-al-nawawi), [Ibn Hajar](/scholars/ibn-hajar-al-asqalani), [Imam al-Shafi'i](/scholars/imam-al-shafii), and the vast majority classify it into five categories |
...
**[The Scholarly Consensus on Innovation →](/scholars/lineage)**
...
- [What is bid'a in Islam?](/faq/what-is-bidah) — The specific question answered concisely
- [Is tawassul shirk?](/faq/is-tawassul-shirk) — A practice often called bid'a by its critics
- [Can you visit graves?](/faq/can-you-visit-graves) — Another practice labeled as innovation
- [Can I say 'Ya Muhammad'?](/faq/can-i-say-ya-muhammad) — Tawassul and the bid'a objection
